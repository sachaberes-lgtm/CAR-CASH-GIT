...
const CACHE = 'cashcar-v2';
const CORE = ['./', './index.html', './manifest.webmanifest', './icon.svg',
  './assets/audio/announcer/launch400.mp3',
  './assets/audio/announcer/meteor.mp3',
  './assets/audio/announcer/early_dead.mp3',
  './assets/audio/announcer/triple_monstre.mp3',
  './assets/audio/announcer/snake_loop.mp3',
  './assets/audio/announcer/pure_speed.mp3',
  './assets/audio/announcer/mega_meteor.mp3',
  './assets/audio/announcer/monstre.mp3',
  './assets/audio/announcer/double_monstre.mp3'];
